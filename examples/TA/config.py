...
NETWORK_CACHE = [0.01,0.05,0.1,0.15]
...
METRIC_DICT = [
    "nx.pagerank(topology)",
    "nx.betweenness_centrality(topology)",
    "nx.closeness_centrality(topology)",
    "nx.eigenvector_centrality(topology)",
    "nx.degree(topology)",
]
        ...
        for topology in TOPOLOGIES:
            for cache_placement in CACHE_PLACEMENT:
                for network_cache in NETWORK_CACHE:
                    for metric_dict in METRIC_DICT:
                        ...
                        experiment["cache_placement"]["metric_dict"] = metric_dict
                        experiment[
                            "desc"
                        ] = "Alpha: {}, strategy: {}, topology: {}, cache_placement: {}, network cache: {}, metric_cache: {}".format(
                            str(alpha),
                            strategy,
                            topology,
                            cache_placement,
